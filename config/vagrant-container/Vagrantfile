...
# Use modern network card
VIRTIO_NIC_TYPE = "virtio"
PRIVATE_NETWORK = ENV['PRIVATE_NETWORK'] || "192.168.56.10"
...
Vagrant.configure(2) do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
    ...
    # VM network card. Use the paravirtuaised virtio network setting
    # for best performance especially with Docker image downloads
    vb.customize ["modifyvm", :id, "--nictype1", VIRTIO_NIC_TYPE]
  ...
  config.vm.synced_folder "./", "/srv/vagrant" #, :nfs => true 
